...
class EmbedBuilder:
    ...
    def help_embed() -> discord.Embed:
        ...
        embed.add_field(
            name="🎮 اللعب الفردي",
            value="استخدم `/قصص_فردية` للتصفح أو `/لعب_فردي` بالاسم/المعرّف عبر الاقتراحات التلقائية.",
            inline=False,
        )
        embed.add_field(
        ...
        embed.add_field(
            ...
            value="`/تشخيص_النيكسوس` لفحص الإعدادات • `/قائمة_القصص` لعرض القصص والمعرّفات.",
            inline=False,
        )
